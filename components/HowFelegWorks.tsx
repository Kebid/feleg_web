    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="relative flex flex-col md:flex-row md:items-stretch md:justify-between gap-10 md:gap-0">
          ...
          <div className="hidden md:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-100/50 via-purple-100/50 to-pink-100/50 dark:from-blue-900/50 dark:via-purple-900/50 dark:to-blue-950/50 z-0 backdrop-blur-sm" style={{transform: 'translateY(-50%)'}} />
          {steps.map((step, i) => (
            <motion.div
              key={step.title}
              initial="hidden"
              ...
              className="relative z-10 bg-white/80 dark:bg-gray-900/80 rounded-2xl shadow-2xl p-8 flex flex-col items-center text-center transition-all duration-300 hover:shadow-3xl hover:-translate-y-2 group mx-auto md:w-1/3 w-full backdrop-blur-md border border-white/20 dark:border-gray-700/20"
            >
              {/* Icon */}
              {step.icon}
