          ...
          {menuOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed inset-0 z-[99] bg-black/60 backdrop-blur-2xl"
              ...
              <motion.div
                ...
                className="fixed top-0 left-0 w-4/5 max-w-xs h-full bg-white/98 dark:bg-gray-900/98 backdrop-blur shadow-2xl z-[100] flex flex-col p-0"
